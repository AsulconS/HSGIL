...
// Form Buttons from 0x140 to 0x14F
...
// Mouse Extra Buttons
    ...
    MOUSE_BUTTON_TURN_WHEEL_UP    = 0x150,
    MOUSE_BUTTON_TURN_WHEEL_DOWN  = 0x151,
    MOUSE_BUTTON_PUSH_WHEEL_LEFT  = 0x152,
    MOUSE_BUTTON_PUSH_WHEEL_RIGHT = 0x153,
