...
%CXX% %CXX_FLAGS% %INCLUDE_PATH% /D HSGIL_STATIC_BUILD /c src/window/window.cpp
...
%LIBMKR% /out:hsgil-window.lib window.obj win32WindowManager.obj eventHandler.obj inputControl.obj inputTrigger.obj wUtils.obj
